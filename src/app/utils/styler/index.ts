...
const TABLE_HOVERED_COLOR = "#808080" + "40"; // Adding 0.25 alpha to the color;
...
export const defaultStyler = (feature: any): Style => {
...
export const checkboxStyler = (feature: any): Style => {
    const selected = feature.get(SELECTED_PROPERTY);
    // Selected
    return selected
        ? new Style({
...
export const podStyler = (feature: any): Style => {
...
export const labelStyler = (feature: any): Style => {
...
export const tableIconStyler = (feature: any, resolution: any) => {
    const color = feature.get("state") === TableState.None ? "#808080" : "#000000";
    ...
    return new Style({
        text: new Text({
            ...
            offsetY: size / 2,
            text: "table",
            font: `400 ${size}px inherit`,
            fill: new Fill({ color }),
        }),
    });
};

export const tableBorderFeatureStyler = (feature: any) => {
...
export const customLabelStyler = (feature: any): Style => {
    const color = feature.get(COLOR_PROPERTY);
    const highlighted = feature.get(HIGHLIGHTED_PROPERTY);
...
export const modifyStyler = (_feature: any, resolution: any) => {
    const color = "#000000";
    const size = getTextSize(resolution, 20 /*targetSize*/);
